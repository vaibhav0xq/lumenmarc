Source: https://docs.base.org/base-chain/specs/upgrades/beryl/b20
Title: B20 Native Token Standard
Fetched: 2026-09-07T11:07:41.795Z
...
> Learn how B20, Base's native token standard, serves stablecoin issuers, real-world asset (RWA) and equity issuers, and long-tail token creators.

B20 is the Base ecosystem's own version of ERC-20. It ships with a built-in compliance toolkit: transfer policies, freeze-and-reissue controls, role-based access control, memos, and supply caps. The released Beryl interfaces are available in Base Standard Library v1.0.0.
